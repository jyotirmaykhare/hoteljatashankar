...
const WHATSAPP_URL = 'https://wa.me/917566199040?text=Hello%20Hotel%20Jatashankar%2C%20I%20would%20like%20to%20order%20food.';
...
export default function Menu() {
  ...
  return (
    <main className="min-h-screen bg-background pb-20 pt-24">
      <section className="bg-primary bg-[url('/restaurant-interior.jpg')] bg-cover bg-center bg-blend-overlay py-14 text-primary-foreground md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="mt-7 flex flex-wrap justify-center gap-3">
            <a href="tel:+917566199040" className="inline-flex items-center gap-2 rounded-md bg-secondary px-4 py-2.5 font-semibold text-primary transition-colors hover:bg-secondary/90"><Phone className="h-4 w-4" />Call</a>
      ...
      <section className="container mx-auto px-4 py-12"><div className="rounded-xl bg-primary p-6 text-primary-foreground md:flex md:items-center md:justify-between"><div><h2 className="font-serif text-2xl text-secondary">Planning lunch or dinner in Chhatarpur?</h2><p className="mt-2 text-primary-foreground/80">Explore our <Link href="/restaurant" className="underline">pure veg restaurant</Link>, see our <Link href="/nearby" className="underline">nearby attractions</Link>, or call for today’s availability.</p></div><div className="mt-5 flex flex-wrap gap-3 md:mt-0"><a href="tel:+917566199040" className="rounded-md bg-secondary px-5 py-2.5 font-semibold text-primary hover:bg-secondary/90">Call Restaurant</a><Link href="/contact" className="rounded-md border border-secondary px-5 py-2.5 font-semibold text-secondary hover:bg-secondary/10">Contact Us</Link></div></div></section>
      <FloatingCTAs />
    </main>
  );
}
