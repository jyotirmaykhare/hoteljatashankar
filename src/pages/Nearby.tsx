      ...
      <section className="py-16">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="mt-16 bg-muted p-8 rounded-2xl border border-border flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <a href="tel:+917566199040" className="bg-primary text-primary-foreground px-8 py-3 rounded-md font-semibold hover:bg-primary/90 transition-colors shrink-0 whitespace-nowrap">
              Contact Reception
            </a>
          </div>
        </div>
