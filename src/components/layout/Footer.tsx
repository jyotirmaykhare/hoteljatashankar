      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li className="flex gap-3 text-primary-foreground/80 text-sm items-center">
                ...
                <a href="tel:+917566199040" className="hover:text-secondary transition-colors">+91 75661 99040</a>
              </li>
              <li className="flex gap-3 text-primary-foreground/80 text-sm items-center">
          ...
          <div>
            ...
            <a href="https://wa.me/917566199040" target="_blank" rel="noopener noreferrer" className="inline-block w-full text-center bg-secondary text-primary font-semibold py-3 px-6 rounded-md hover:bg-secondary/90 transition-colors shadow-sm">
              WhatsApp Us
            </a>
