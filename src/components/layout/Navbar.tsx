        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex flex-col group">
            <span className={`text-2xl md:text-3xl font-serif font-bold tracking-tight transition-colors ${
              isScrolled ? 'text-primary' : 'text-primary lg:text-white drop-shadow-md'
            }`}>
              Hotel Jatashankar
            </span>
            <span className={`text-xs md:text-sm tracking-widest uppercase transition-colors ${
              isScrolled ? 'text-secondary' : 'text-secondary lg:text-gold-200 drop-shadow-md'
            }`}>
              Premium Stay & Dining
            </span>
          </Link>
